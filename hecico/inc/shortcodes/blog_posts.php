<?php
// [blog_posts]
function hecico_latest_from_blog($atts, $content = null, $tag) {
...
remove_shortcode("blog_posts", "shortcode_latest_from_blog");
add_shortcode("blog_posts", "hecico_latest_from_blog");